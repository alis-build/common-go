...
const file_alis_open_agent_v2_a2a_proto_rawDesc = "" +
	...
	" DeleteTaskPushNotificationConfig\x12;.alis.open.agent.v2.DeleteTaskPushNotificationConfigRequest\x1a\x16.google.protobuf.Empty\";\xdaA\x04name\x82\xd3\xe4\x93\x02.*,/v1/{name=tasks/*/pushNotificationConfigs/*}B)Z'go.alis.build/common/alis/open/agent/v2b\x06proto3"
