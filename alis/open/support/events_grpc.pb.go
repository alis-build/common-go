...
const (
	EventsService_HandleEvent_FullMethodName = "/alis.open.support.v1.EventsService/HandleEvent"
)
...
func (c *eventsServiceClient) HandleEvent(ctx context.Context, in *pubsub.PubSubMessage, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedEventsServiceServer) HandleEvent(context.Context, *pubsub.PubSubMessage) (*emptypb.Empty, error) {
...
func _EventsService_HandleEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pubsub.PubSubMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EventsServiceServer).HandleEvent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EventsService_HandleEvent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventsServiceServer).HandleEvent(ctx, req.(*pubsub.PubSubMessage))
	}
...
var EventsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "alis.open.support.v1.EventsService",
	HandlerType: (*EventsServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "HandleEvent",
			Handler:    _EventsService_HandleEvent_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "alis/open/support/v1/events.proto",
}
